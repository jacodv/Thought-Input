...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        CaptureLog.ui.info("Brain Input launched")
    }
    ...
    private func setupMenuBar() {
        ...
        if let button = statusItem.button {
            button.image = NSImage(systemSymbolName: "brain.head.profile", accessibilityDescription: "Brain Input")
        ...
        menu.addItem(NSMenuItem.separator())
        menu.addItem(NSMenuItem(title: "Quit Brain Input", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
    ...
    @objc private func showSettings() {
        ...
        settingsWindow.title = "Brain Input Settings"
